...
@Autonomous(name="Specimen Auto5")
...
public class SpecimenAuto5 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        SequentialCommandGroup auto = new SequentialCommandGroup(
                ...
                new SetClawPIDCommand(bot.getClaw(), 66),
                new SetExtensionCommand(bot.getExtension(), bot.getClaw(), bot.getIntake(), 1100,true),
                ...
                new SetExtensionCommand(bot.getExtension(),bot.getClaw(),bot.getIntake() ,1800,true),
                new WaitCommand(3000),



                new WaitCommand(33000),
                new SetExtensionCommand(bot.getExtension(),bot.getClaw(),bot.getIntake() ,0,false),
                new WaitCommand(3000),
                new SetPivotAngleCommand(bot.getPivot(), bot.getClaw(), Pivot.setpoint_horizontal)
