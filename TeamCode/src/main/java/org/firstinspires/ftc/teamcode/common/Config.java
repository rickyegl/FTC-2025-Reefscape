...
public class Config {
    ...
    public static double pivot_kP = 0.05, pivot_kI = 0.0, pivot_kD = 0.000, pivot_n_kF = -0.000, pivot_hN_kF = -0.0000, pivot_h_kF = -0.006, pivot_maxH_kF = -0., pivot_tolerance = 6.0;
    //0.0009
