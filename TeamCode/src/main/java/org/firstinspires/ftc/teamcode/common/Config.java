...
public class Config {
    ...
    public static double pivot_kP = 0.05, pivot_kI = 0.0, pivot_kD = 0.000, pivot_n_kF = -0.005, pivot_hN_kF = -0.0005, pivot_h_kF = -0.05, pivot_maxH_kF = -0., pivot_tolerance = 6.0;
    //0.0009
    ...
    public static double claw_kP = 0.01, claw_kI = 0.0, claw_kD = 0.0, claw_kF = 0.003, claw_tolerance = 2.0, claw_init = 0.0;
